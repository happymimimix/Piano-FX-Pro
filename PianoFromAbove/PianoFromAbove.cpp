...
INT WINAPI WinMain(HINSTANCE hInstance, HINSTANCE, LPSTR, INT nCmdShow)
{
    ...
    if (__argc == 3) {
        ...
        if (ARG1 == "OPEN") {
            if (ARG2 == "PFXSTUDIO") {
                ...
                Code += "SetMicroseconds(GetInitialSilence())\n";
                Code += "SetVolume(1.00)\n";
                Code += "SetMute(0)\n";
                ...
                Code += "RunShaderByTime(GetInitialSilence(),GetInitialSilence()+2*S,ReversedDarkFadeShader)\n";
                Code += "RunShaderByTime(GetInitialSilence(),GetInitialSilence()+2*S,ReversedGlassFadeShader,nil,10,0)\n";
                Code += "RunShaderByTime(GetInitialSilence(),GetInitialSilence()+2*S,ReversedGlassFadeShader,nil,20,0)\n";
                Code += "SmoothAnimationByTime(0,1,GetInitialSilence()+S,GetInitialSilence()+3*S,EaseOutBack,SetZoom)\n";
                Code += "SmoothAnimationByTime(CenterX(0),CenterX(1),GetInitialSilence()+S,GetInitialSilence()+3*S,EaseOutBack,SetOffsetX)\n";
                Code += "SmoothAnimationByTime(CenterY(0),CenterY(1),GetInitialSilence()+S,GetInitialSilence()+3*S,EaseOutBack,SetOffsetY)\n";
    ...
    g_hWnd = CreateWindowEx(NULL, CLASSNAME, TitleIdle, WS_OVERLAPPEDWINDOW | WS_CLIPCHILDREN, cView.GetMainLeft(), cView.GetMainTop(), cView.GetMainWidth(), cView.GetMainHeight(), NULL, NULL, wc.hInstance, NULL);

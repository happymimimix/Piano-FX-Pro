...
struct Tab2Graphics {
    ...
    struct Btn4Graphics {
        static void Main(uint8_t x, uint8_t y) {
            ...
            cout << "[" << (short)y << ';' << (short)x << "H[44m[36m│[95m Animation type: │                    │ │            │                   [36m│"; y++;
            cout << "[" << (short)y << ';' << (short)x << "H[44m[36m│[95m                 └────────────────────┘ └────────────┘                   [36m│"; y++;
            cout << "[" << (short)y << ';' << (short)x << "H[44m[36m│[95m                   ┌────────────────────┐              ┌────────────┐    [36m│"; y++;
            cout << "[" << (short)y << ';' << (short)x << "H[44m[36m│[95m Animation target: │                    │ Timing unit: │            │    [36m│"; y++;
            cout << "[" << (short)y << ';' << (short)x << "H[44m[36m│[95m                   └────────────────────┘              └────────────┘    [36m│"; y++;
            cout << "[" << (short)y << ';' << (short)x << "H[44m[36m│[95m             ┌──────────────────┐           ┌──────────────────┐         [36m│"; y++;
            ...
            cout << "[" << (short)y << ';' << (short)x << "H[44m[36m│[95m Slice interval: │                  │       [93m[[91m*[93m] Use threads[95m [91m│ [92mGenerate[92m [91m│[95m [36m│"; y++;
            cout << "[" << (short)y << ';' << (short)x << "H[44m[36m│[95m                 └──────────────────┘                       [91m└──────────┘[95m [36m│"; y++;

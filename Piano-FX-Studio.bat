...
ECHO.local i=0 >>"%~dp0x"
ECHO.while i^<=H do >>"%~dp0x"
ECHO.EXE(^"BitBlt^",MEMdc_Main,math.random(-math.abs(ShiftingAmount),math.abs(ShiftingAmount)),i,W,MaxWaveHeight,MEMdc_R,0,i,SRCPAINT) >>"%~dp0x"
ECHO.EXE(^"BitBlt^",MEMdc_Main,math.random(-math.abs(ShiftingAmount),math.abs(ShiftingAmount)),i,W,MaxWaveHeight,MEMdc_G,0,i,SRCPAINT) >>"%~dp0x"
ECHO.EXE(^"BitBlt^",MEMdc_Main,math.random(-math.abs(ShiftingAmount),math.abs(ShiftingAmount)),i,W,MaxWaveHeight,MEMdc_B,0,i,SRCPAINT) >>"%~dp0x"

...
ECHO.       [97m╔════════════════════════════════════════════════════════════════╗       
ECHO.       [97m║                   [93m┌────────────────────────┐                   [97m║       
ECHO.       [97m║ [91m»»»»»»»»»»»»»»»»» [93m│ [95mPiano FX Studio v1.03  [93m│ [91m««««««««««««««««« [97m║       
...
ECHO|set/p=[15;12H[107m[30m (C) Run Piano FX Pro v1.03                               [100m [40m
...
ECHO|set/p=[23;10H[97m╧═══════════╧═╧═════════════╧═╧═══════════╧
ECHO|set/p=[8;12H[40m[97m▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄
ECHO|set/p=[9;12H[107m[30m (A) Generate color events from lyrics (Domino only^^^!)     [100m [40m
ECHO|set/p=[10;12H[40m[97m▀[100m▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀ [40m
ECHO|set/p=[11;12H[40m[97m▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄
ECHO|set/p=[12;12H[107m[30m (B) Generate color events from a color event script      [100m [40m
ECHO|set/p=[13;12H[40m[97m▀[100m▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀ [40m
CHOICE /C 12ab /N >nul
if "%errorlevel%" equ "1" (goto Setup)
...
ECHO|set/p=[15;12H[103m[30m (C) Run Piano FX Pro v1.03                               [40m 
...
ECHO.end >>"%~dp0x"
ECHO.function GetResolution() >>"%~dp0x"
ECHO.return readInteger(Resolution) >>"%~dp0x"
ECHO.end >>"%~dp0x"
ECHO.function GetMeasureLength() >>"%~dp0x"
ECHO.return GetResolution()*4 >>"%~dp0x"
ECHO.end >>"%~dp0x"
...
ECHO.TotalTicks=GetMeasureLength()*10 >>"%~dp0x"

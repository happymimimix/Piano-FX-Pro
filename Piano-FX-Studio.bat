...
ECHO.       [97m╔════════════════════════════════════════════════════════════════╗       
ECHO.       [97m║                   [93m┌────────────────────────┐                   [97m║       
ECHO.       [97m║ [91m»»»»»»»»»»»»»»»»» [93m│ [95mPiano-FX Studio v3.04  [93m│ [91m««««««««««««««««« [97m║       
...
ECHO|set/p=[18;12H[107m[30m (D) Run Piano-FX Pro v3.04                               [100m [40m
...
ECHO|set/p=[18;12H[103m[30m (D) Run Piano FX Pro v3.04                               [40m 
...
ECHO.Microseconds=^"Piano-FX-Pro.exe+9996B0^" >>"%~dp0x"
ECHO.Ticks=^"Piano-FX-Pro.exe+999754^" >>"%~dp0x"
ECHO.Resolution=^"Piano-FX-Pro.exe+995318^" >>"%~dp0x"
ECHO.Volume=^"Piano-FX-Pro.exe+999568^" >>"%~dp0x"
ECHO.Mute=^"Piano-FX-Pro.exe+999556^" >>"%~dp0x"
ECHO.PlaybackSpeed=^"Piano-FX-Pro.exe+999558^" >>"%~dp0x"
ECHO.NoteSpeed=^"Piano-FX-Pro.exe+999560^" >>"%~dp0x"
ECHO.OffsetX=^"Piano-FX-Pro.exe+999580^" >>"%~dp0x"
ECHO.OffsetY=^"Piano-FX-Pro.exe+999584^" >>"%~dp0x"
ECHO.Zoom=^"Piano-FX-Pro.exe+999588^" >>"%~dp0x"
ECHO.StartKey=^"Piano-FX-Pro.exe+999484^" >>"%~dp0x"
ECHO.EndKey=^"Piano-FX-Pro.exe+999488^" >>"%~dp0x"
ECHO.KeyMode=^"Piano-FX-Pro.exe+999480^" >>"%~dp0x"
ECHO.Width=^"Piano-FX-Pro.exe+995310^" >>"%~dp0x"
ECHO.Height=^"Piano-FX-Pro.exe+995314^" >>"%~dp0x"
ECHO.Paused=^"Piano-FX-Pro.exe+999555^" >>"%~dp0x"
ECHO.Keyboard=^"Piano-FX-Pro.exe+999579^" >>"%~dp0x"
ECHO.VisualizePitchBends=^"Piano-FX-Pro.exe+9995D8^" >>"%~dp0x"
ECHO.PhigrosMode=^"Piano-FX-Pro.exe+9995B0^" >>"%~dp0x"
ECHO.ShowMarkers=^"Piano-FX-Pro.exe+9995A9^" >>"%~dp0x"
ECHO.TickBased=^"Piano-FX-Pro.exe+9995A8^" >>"%~dp0x"
ECHO.DisableUI=^"Piano-FX-Pro.exe+999602^" >>"%~dp0x"
ECHO.LimitFPS=^"Piano-FX-Pro.exe+999529^" >>"%~dp0x"
ECHO.Caption=^"Piano-FX-Pro.exe+995320^" >>"%~dp0x"
ECHO.MS=1e+3 >>"%~dp0x"
ECHO.S=1e+6 >>"%~dp0x"
ECHO.LastUpdate=os.time()*S+os.clock()*S >>"%~dp0x"
...
ECHO.end >>"%~dp0x"
ECHO.end >>"%~dp0x"
ECHO.function UpdateShaderFPSDisplay() >>"%~dp0x"
ECHO.if DisplayShaderFPS then >>"%~dp0x"
ECHO.local FrameTime=(os.time()*S+os.clock()*S)-LastUpdate+1 >>"%~dp0x"
ECHO.local FPS=math.ceil((S/FrameTime)*100.0)/100.0 >>"%~dp0x"
ECHO.local Text=^"Shader FPS: ^"..FPS >>"%~dp0x"
ECHO.local Font=EXE(^"CreateFontA^", >>"%~dp0x"
ECHO.16,-- FontHeight >>"%~dp0x"
ECHO.0,-- FontWidth >>"%~dp0x"
ECHO.0,-- Escapement >>"%~dp0x"
ECHO.0,-- Orientation >>"%~dp0x"
ECHO.400,-- FontWeight >>"%~dp0x"
ECHO.0,-- Italic >>"%~dp0x"
ECHO.0,-- Underline >>"%~dp0x"
ECHO.0,-- StrikeOut >>"%~dp0x"
ECHO.1,-- CharSet >>"%~dp0x"
ECHO.0,-- OutPrecision >>"%~dp0x"
ECHO.0,-- ClipPrecision >>"%~dp0x"
ECHO.0,-- Quality >>"%~dp0x"
ECHO.0,-- PitchAndFamily >>"%~dp0x"
ECHO.^"Fixedsys^")-- FaceName >>"%~dp0x"
ECHO.EXE(^"SelectObject^",GDIdc,Font) >>"%~dp0x"
ECHO.EXE(^"SetBkMode^",GDIdc,1) >>"%~dp0x"
ECHO.EXE(^"SetTextColor^",GDIdc,0x000000) >>"%~dp0x"
ECHO.EXE(^"TextOutA^",GDIdc,16,16,Text,#Text) >>"%~dp0x"
ECHO.EXE(^"SetTextColor^",GDIdc,0xFFFFFF) >>"%~dp0x"
ECHO.EXE(^"TextOutA^",GDIdc,15,15,Text,#Text) >>"%~dp0x"
...
ECHO.UpdateShaderFPSDisplay() >>"%~dp0x"
ECHO.end >>"%~dp0x"
...
ECHO.end >>"%~dp0x"
ECHO.end >>"%~dp0x"
ECHO.function WaveGlitchShader(t,MaxWaveHeight,MinWaveHeight,ShiftingAmount) >>"%~dp0x"
ECHO.if MaxWaveHeight==nil then MaxWaveHeight=10 end >>"%~dp0x"
ECHO.if MinWaveHeight==nil then MinWaveHeight=5 end >>"%~dp0x"
ECHO.if ShiftingAmount==nil then ShiftingAmount=10 end >>"%~dp0x"
ECHO.local i=0 >>"%~dp0x"
...
ECHO.EXE(^"BitBlt^",GDIdc,math.random(-math.abs(ShiftingAmount),math.abs(ShiftingAmount)),i,GetWidth(),MaxWaveHeight,PFXdc,0,i,SRCPAINT) >>"%~dp0x"
ECHO.else >>"%~dp0x"
ECHO.EXE(^"BitBlt^",GDIdc,math.random(-math.abs(ShiftingAmount),math.abs(ShiftingAmount)),i,GetWidth(),MaxWaveHeight,PFXdc,0,i,SRCAND) >>"%~dp0x"
ECHO.end >>"%~dp0x"
ECHO.i=i+math.random(MinWaveHeight,MaxWaveHeight) >>"%~dp0x"
ECHO.end >>"%~dp0x"
ECHO.end >>"%~dp0x"
...
ECHO.EXE(^"DeleteDC^",MEMdc) >>"%~dp0x"
ECHO.end >>"%~dp0x"
ECHO.function BetterColorOffsetShader(t,OffsettingAmount) >>"%~dp0x"
ECHO.if OffsettingAmount==nil then OffsettingAmount=5 end >>"%~dp0x"
ECHO.local W=GetWidth() >>"%~dp0x"
ECHO.local H=GetHeight() >>"%~dp0x"
ECHO.local MEMdc_R=EXE(^"CreateCompatibleDC^",GDIdc) >>"%~dp0x"
ECHO.local BMP_R=EXE(^"CreateCompatibleBitmap^",GDIdc,W,H) >>"%~dp0x"
ECHO.local MEMdc_G=EXE(^"CreateCompatibleDC^",GDIdc) >>"%~dp0x"
ECHO.local BMP_G=EXE(^"CreateCompatibleBitmap^",GDIdc,W,H) >>"%~dp0x"
ECHO.local MEMdc_B=EXE(^"CreateCompatibleDC^",GDIdc) >>"%~dp0x"
ECHO.local BMP_B=EXE(^"CreateCompatibleBitmap^",GDIdc,W,H) >>"%~dp0x"
ECHO.local MEMdc_Main=EXE(^"CreateCompatibleDC^",GDIdc) >>"%~dp0x"
ECHO.local BMP_Main=EXE(^"CreateCompatibleBitmap^",GDIdc,W,H) >>"%~dp0x"
ECHO.EXE(^"SelectObject^",MEMdc_R,BMP_R) >>"%~dp0x"
ECHO.local Brush=EXE(^"CreateSolidBrush^",0x0000FF) >>"%~dp0x"
ECHO.EXE(^"SelectObject^",MEMdc_R,Brush) >>"%~dp0x"
ECHO.EXE(^"PatBlt^",MEMdc_R,0,0,W,H,PATCOPY) >>"%~dp0x"
ECHO.EXE(^"DeleteObject^",Brush) >>"%~dp0x"
ECHO.EXE(^"BitBlt^",MEMdc_R,0,0,W,H,PFXdc,0,0,SRCAND) >>"%~dp0x"
ECHO.EXE(^"SelectObject^",MEMdc_G,BMP_G) >>"%~dp0x"
ECHO.local Brush=EXE(^"CreateSolidBrush^",0x00FF00) >>"%~dp0x"
ECHO.EXE(^"SelectObject^",MEMdc_G,Brush) >>"%~dp0x"
ECHO.EXE(^"PatBlt^",MEMdc_G,0,0,W,H,PATCOPY) >>"%~dp0x"
ECHO.EXE(^"DeleteObject^",Brush) >>"%~dp0x"
ECHO.EXE(^"BitBlt^",MEMdc_G,0,0,W,H,PFXdc,0,0,SRCAND) >>"%~dp0x"
ECHO.EXE(^"SelectObject^",MEMdc_B,BMP_B) >>"%~dp0x"
ECHO.local Brush=EXE(^"CreateSolidBrush^",0xFF0000) >>"%~dp0x"
ECHO.EXE(^"SelectObject^",MEMdc_B,Brush) >>"%~dp0x"
ECHO.EXE(^"PatBlt^",MEMdc_B,0,0,W,H,PATCOPY) >>"%~dp0x"
ECHO.EXE(^"DeleteObject^",Brush) >>"%~dp0x"
ECHO.EXE(^"BitBlt^",MEMdc_B,0,0,W,H,PFXdc,0,0,SRCAND) >>"%~dp0x"
ECHO.EXE(^"SelectObject^",MEMdc_Main,BMP_Main) >>"%~dp0x"
ECHO.EXE(^"BitBlt^",MEMdc_Main,math.random(-math.abs(OffsettingAmount),math.abs(OffsettingAmount)),math.random(-math.abs(OffsettingAmount),math.abs(OffsettingAmount)),W,H,MEMdc_R,0,0,SRCPAINT) >>"%~dp0x"
ECHO.EXE(^"BitBlt^",MEMdc_Main,math.random(-math.abs(OffsettingAmount),math.abs(OffsettingAmount)),math.random(-math.abs(OffsettingAmount),math.abs(OffsettingAmount)),W,H,MEMdc_G,0,0,SRCPAINT) >>"%~dp0x"
ECHO.EXE(^"BitBlt^",MEMdc_Main,math.random(-math.abs(OffsettingAmount),math.abs(OffsettingAmount)),math.random(-math.abs(OffsettingAmount),math.abs(OffsettingAmount)),W,H,MEMdc_B,0,0,SRCPAINT) >>"%~dp0x"
ECHO.EXE(^"BitBlt^",GDIdc,0,0,W,H,MEMdc_Main,0,0,SRCCOPY) >>"%~dp0x"
ECHO.EXE(^"DeleteObject^",BMP_R) >>"%~dp0x"
ECHO.EXE(^"DeleteDC^",MEMdc_R) >>"%~dp0x"
ECHO.EXE(^"DeleteObject^",BMP_G) >>"%~dp0x"
ECHO.EXE(^"DeleteDC^",MEMdc_G) >>"%~dp0x"
ECHO.EXE(^"DeleteObject^",BMP_B) >>"%~dp0x"
ECHO.EXE(^"DeleteDC^",MEMdc_B) >>"%~dp0x"
ECHO.EXE(^"DeleteObject^",BMP_Main) >>"%~dp0x"
ECHO.EXE(^"DeleteDC^",MEMdc_Main) >>"%~dp0x"
ECHO.end >>"%~dp0x"
ECHO.function BetterColorOffsetWaveShader(t,OffsettingAmount,MaxWaveHeight,MinWaveHeight,ShiftingAmount) >>"%~dp0x"
ECHO.if OffsettingAmount==nil then OffsettingAmount=5 end >>"%~dp0x"
ECHO.if MaxWaveHeight==nil then MaxWaveHeight=40 end >>"%~dp0x"
ECHO.if MinWaveHeight==nil then MinWaveHeight=10 end >>"%~dp0x"
ECHO.if ShiftingAmount==nil then ShiftingAmount=10 end >>"%~dp0x"
...
ECHO.EXE(^"SelectObject^",MEMdc_Main,BMP_Main) >>"%~dp0x"
ECHO.local i=0 >>"%~dp0x"
ECHO.local OffsetRX=math.random(-math.abs(OffsettingAmount),math.abs(OffsettingAmount)) >>"%~dp0x"
ECHO.local OffsetRY=math.random(-math.abs(OffsettingAmount),math.abs(OffsettingAmount)) >>"%~dp0x"
ECHO.local OffsetGX=math.random(-math.abs(OffsettingAmount),math.abs(OffsettingAmount)) >>"%~dp0x"
ECHO.local OffsetGY=math.random(-math.abs(OffsettingAmount),math.abs(OffsettingAmount)) >>"%~dp0x"
ECHO.local OffsetBX=math.random(-math.abs(OffsettingAmount),math.abs(OffsettingAmount)) >>"%~dp0x"
ECHO.local OffsetBY=math.random(-math.abs(OffsettingAmount),math.abs(OffsettingAmount)) >>"%~dp0x"
ECHO.while i^<=H do >>"%~dp0x"
ECHO.EXE(^"BitBlt^",MEMdc_Main,math.random(-math.abs(ShiftingAmount),math.abs(ShiftingAmount)),i,W,MaxWaveHeight,MEMdc_R,OffsetRX,i+OffsetRY,SRCPAINT) >>"%~dp0x"
ECHO.EXE(^"BitBlt^",MEMdc_Main,math.random(-math.abs(ShiftingAmount),math.abs(ShiftingAmount)),i,W,MaxWaveHeight,MEMdc_G,OffsetRX,i+OffsetRY,SRCPAINT) >>"%~dp0x"
ECHO.EXE(^"BitBlt^",MEMdc_Main,math.random(-math.abs(ShiftingAmount),math.abs(ShiftingAmount)),i,W,MaxWaveHeight,MEMdc_B,OffsetRX,i+OffsetRY,SRCPAINT) >>"%~dp0x"
ECHO.EXE(^"BitBlt^",GDIdc,0,i,W,MaxWaveHeight,MEMdc_Main,0,i,SRCCOPY) >>"%~dp0x"
ECHO.i=i+math.random(MinWaveHeight,MaxWaveHeight) >>"%~dp0x"
ECHO.end >>"%~dp0x"
ECHO.EXE(^"DeleteObject^",BMP_R) >>"%~dp0x"
ECHO.EXE(^"DeleteDC^",MEMdc_R) >>"%~dp0x"
...
ECHO.EXE(^"DeleteDC^",MEMdc) >>"%~dp0x"
ECHO.end >>"%~dp0x"
ECHO.function RadialBlurColorBurnShader(t,MaxRotation,BlendAlpha,Iteration,R,G,B) >>"%~dp0x"
ECHO.if MaxRotation==nil then MaxRotation=0.02 end >>"%~dp0x"
ECHO.if BlendAlpha==nil then BlendAlpha=1^<^<6 end >>"%~dp0x"
ECHO.if Iteration==nil then Iteration=3 end >>"%~dp0x"
ECHO.if R==nil then R=0 end >>"%~dp0x"
...
ECHO.EXE(^"DeleteDC^",MEMdc) >>"%~dp0x"
ECHO.end >>"%~dp0x"
ECHO.function RadialPaintColorBurnShader(t,MaxRotation,Iteration,R,G,B) >>"%~dp0x"
ECHO.if MaxRotation==nil then MaxRotation=0.02 end >>"%~dp0x"
ECHO.if Iteration==nil then Iteration=3 end >>"%~dp0x"
ECHO.if R==nil then R=0 end >>"%~dp0x"
ECHO.if G==nil then G=255 end >>"%~dp0x"
...
ECHO.EXE(^"DeleteDC^",MEMdc) >>"%~dp0x"
ECHO.end >>"%~dp0x"
ECHO.function RadialAndColorBurnShader(t,MaxRotation,Iteration,R,G,B) >>"%~dp0x"
ECHO.if MaxRotation==nil then MaxRotation=0.02 end >>"%~dp0x"
ECHO.if Iteration==nil then Iteration=3 end >>"%~dp0x"
ECHO.if R==nil then R=0 end >>"%~dp0x"
ECHO.if G==nil then G=255 end >>"%~dp0x"
...
ECHO.EXE(^"DeleteDC^",MEMdc) >>"%~dp0x"
ECHO.end >>"%~dp0x"
ECHO.function RadialBlurWaveShader(t,MaxRotation,BlendAlpha,Iteration,MaxWaveHeight,MinWaveHeight,ShiftingAmount) >>"%~dp0x"
ECHO.if MaxRotation==nil then MaxRotation=0.02 end >>"%~dp0x"
ECHO.if BlendAlpha==nil then BlendAlpha=1^<^<6 end >>"%~dp0x"
ECHO.if Iteration==nil then Iteration=3 end >>"%~dp0x"
ECHO.if MaxWaveHeight==nil then MaxWaveHeight=10 end >>"%~dp0x"
...
ECHO.local i=0 >>"%~dp0x"
ECHO.while i^<=GetHeight() do >>"%~dp0x"
ECHO.EXE(^"BitBlt^",GDIdc,math.random(-math.abs(ShiftingAmount),math.abs(ShiftingAmount)),i,W,MaxWaveHeight,MEMdc,0,i,SRCCOPY) >>"%~dp0x"
ECHO.i=i+math.random(MinWaveHeight,MaxWaveHeight) >>"%~dp0x"
ECHO.end >>"%~dp0x"
ECHO.EXE(^"DeleteObject^",BMP) >>"%~dp0x"
ECHO.EXE(^"DeleteDC^",MEMdc) >>"%~dp0x"
ECHO.end >>"%~dp0x"
ECHO.function RadialPaintWaveShader(t,MaxRotation,Iteration,MaxWaveHeight,MinWaveHeight,ShiftingAmount) >>"%~dp0x"
ECHO.if MaxRotation==nil then MaxRotation=0.02 end >>"%~dp0x"
ECHO.if Iteration==nil then Iteration=3 end >>"%~dp0x"
ECHO.if MaxWaveHeight==nil then MaxWaveHeight=10 end >>"%~dp0x"
ECHO.if MinWaveHeight==nil then MinWaveHeight=5 end >>"%~dp0x"
...
ECHO.EXE(^"DeleteDC^",MEMdc) >>"%~dp0x"
ECHO.end >>"%~dp0x"
ECHO.function RadialAndWaveShader(t,MaxRotation,Iteration,MaxWaveHeight,MinWaveHeight,ShiftingAmount) >>"%~dp0x"
ECHO.if MaxRotation==nil then MaxRotation=0.02 end >>"%~dp0x"
ECHO.if Iteration==nil then Iteration=3 end >>"%~dp0x"
ECHO.if MaxWaveHeight==nil then MaxWaveHeight=10 end >>"%~dp0x"
ECHO.if MinWaveHeight==nil then MinWaveHeight=5 end >>"%~dp0x"
...
ECHO.EXE(^"DeleteDC^",MEMdc) >>"%~dp0x"
ECHO.end >>"%~dp0x"
ECHO.function RadialBlurColorBurnWaveShader(t,MaxRotation,BlendAlpha,Iteration,R,G,B,MaxWaveHeight,MinWaveHeight,ShiftingAmount) >>"%~dp0x"
ECHO.if MaxRotation==nil then MaxRotation=0.02 end >>"%~dp0x"
ECHO.if BlendAlpha==nil then BlendAlpha=1^<^<6 end >>"%~dp0x"
ECHO.if Iteration==nil then Iteration=3 end >>"%~dp0x"
ECHO.if R==nil then R=0 end >>"%~dp0x"
...
ECHO.EXE(^"DeleteDC^",MEMdc) >>"%~dp0x"
ECHO.end >>"%~dp0x"
ECHO.function RadialPaintColorBurnWaveShader(t,MaxRotation,Iteration,R,G,B,MaxWaveHeight,MinWaveHeight,ShiftingAmount) >>"%~dp0x"
ECHO.if MaxRotation==nil then MaxRotation=0.02 end >>"%~dp0x"
ECHO.if Iteration==nil then Iteration=3 end >>"%~dp0x"
ECHO.if R==nil then R=0 end >>"%~dp0x"
ECHO.if G==nil then G=255 end >>"%~dp0x"
...
ECHO.EXE(^"DeleteDC^",MEMdc) >>"%~dp0x"
ECHO.end >>"%~dp0x"
ECHO.function RadialAndColorBurnWaveShader(t,MaxRotation,Iteration,R,G,B,MaxWaveHeight,MinWaveHeight,ShiftingAmount) >>"%~dp0x"
ECHO.if MaxRotation==nil then MaxRotation=0.02 end >>"%~dp0x"
ECHO.if Iteration==nil then Iteration=3 end >>"%~dp0x"
ECHO.if R==nil then R=0 end >>"%~dp0x"
ECHO.if G==nil then G=255 end >>"%~dp0x"
...
ECHO.end >>"%~dp0x"
ECHO.end >>"%~dp0x"
ECHO.function InvertPolygonGlitchShader(t,MaxSides,MinSides,MaxRadius,MinRadius,MaxCount,MinCount,Delay,MaxSectionWidth,MinSectionWidth,ShiftingAmount) >>"%~dp0x"
ECHO.if MaxSides==nil then MaxSides=10 end >>"%~dp0x"
ECHO.if MinSides==nil then MinSides=3 end >>"%~dp0x"
ECHO.if MaxRadius==nil then MaxRadius=400 end >>"%~dp0x"
ECHO.if MinRadius==nil then MinRadius=100 end >>"%~dp0x"
ECHO.if MaxCount==nil then MaxCount=3 end >>"%~dp0x"
ECHO.if MinCount==nil then MinCount=0 end >>"%~dp0x"
ECHO.if Delay==nil then Delay=20 end >>"%~dp0x"
ECHO.if MaxSectionWidth==nil then MaxSectionWidth=150 end >>"%~dp0x"
ECHO.if MinSectionWidth==nil then MinSectionWidth=10 end >>"%~dp0x"
ECHO.if ShiftingAmount==nil then ShiftingAmount=10 end >>"%~dp0x"
ECHO.local W=GetWidth() >>"%~dp0x"
...
ECHO.end >>"%~dp0x"
ECHO.end >>"%~dp0x"
ECHO.function ColorPolygonGlitchShader(t,MaxSides,MinSides,MaxRadius,MinRadius,MaxCount,MinCount,Delay,R,G,B,MaxSectionWidth,MinSectionWidth,ShiftingAmount) >>"%~dp0x"
ECHO.if MaxSides==nil then MaxSides=10 end >>"%~dp0x"
ECHO.if MinSides==nil then MinSides=3 end >>"%~dp0x"
ECHO.if MaxRadius==nil then MaxRadius=400 end >>"%~dp0x"
ECHO.if MinRadius==nil then MinRadius=100 end >>"%~dp0x"
...
ECHO.end >>"%~dp0x"
ECHO.end >>"%~dp0x"
ECHO.function RandomColorPolygonGlitchShader(t,MaxSides,MinSides,MaxRadius,MinRadius,MaxCount,MinCount,Delay,MaxSectionWidth,MinSectionWidth,ShiftingAmount) >>"%~dp0x"
ECHO.if MaxSides==nil then MaxSides=10 end >>"%~dp0x"
ECHO.if MinSides==nil then MinSides=3 end >>"%~dp0x"
ECHO.if MaxRadius==nil then MaxRadius=400 end >>"%~dp0x"
ECHO.if MinRadius==nil then MinRadius=100 end >>"%~dp0x"
...
ECHO.end >>"%~dp0x"
ECHO.end >>"%~dp0x"
ECHO.function TriangleFrameShader(t,Size,Speed,Transparency,R,G,B) >>"%~dp0x"
ECHO.if Size==nil then Size=200 end >>"%~dp0x"
ECHO.if Speed==nil then Speed=5 end >>"%~dp0x"
ECHO.if Transparency==nil then Transparency=191 end >>"%~dp0x"
ECHO.if R==nil then R=0 end >>"%~dp0x"
ECHO.if G==nil then G=127 end >>"%~dp0x"
ECHO.if B==nil then B=255 end >>"%~dp0x"
ECHO.local W=GetWidth() >>"%~dp0x"
ECHO.local H=GetHeight() >>"%~dp0x"
ECHO.if GlobalOffset==nil then >>"%~dp0x"
ECHO.GlobalOffset=0 >>"%~dp0x"
ECHO.end >>"%~dp0x"
ECHO.local CurrentOffset=GlobalOffset >>"%~dp0x"
ECHO.while CurrentOffset ^> 0 do >>"%~dp0x"
ECHO.CurrentOffset=CurrentOffset-Size >>"%~dp0x"
ECHO.end >>"%~dp0x"
ECHO.local Polygons={} >>"%~dp0x"
ECHO.while CurrentOffset ^<= W+Size do >>"%~dp0x"
ECHO.local X1,Y1=CurrentOffset,Size >>"%~dp0x"
ECHO.local X2,Y2=RotatePoint(X1,Y1,2*math.pi/3,CurrentOffset,0) >>"%~dp0x"
ECHO.local X3,Y3=RotatePoint(X2,Y2,2*math.pi/3,CurrentOffset,0) >>"%~dp0x"
ECHO.MEM.Position=0 >>"%~dp0x"
ECHO.MEM.size=24 >>"%~dp0x"
ECHO.MEM.writeDword(math.floor(X1)) >>"%~dp0x"
ECHO.MEM.writeDword(math.floor(Y1)) >>"%~dp0x"
ECHO.MEM.writeDword(math.floor(X2)) >>"%~dp0x"
ECHO.MEM.writeDword(math.floor(Y2)) >>"%~dp0x"
ECHO.MEM.writeDword(math.floor(X3)) >>"%~dp0x"
ECHO.MEM.writeDword(math.floor(Y3)) >>"%~dp0x"
ECHO.MEM.Position=0 >>"%~dp0x"
ECHO.table.insert(Polygons,EXE(^"CreatePolygonRgn^",MEM.Memory,3,2)) >>"%~dp0x"
ECHO.X1,Y1=RotatePoint(X1,Y1,math.pi,W/2,H/2) >>"%~dp0x"
ECHO.X2,Y2=RotatePoint(X2,Y2,math.pi,W/2,H/2) >>"%~dp0x"
ECHO.X3,Y3=RotatePoint(X3,Y3,math.pi,W/2,H/2) >>"%~dp0x"
ECHO.MEM.Position=0 >>"%~dp0x"
ECHO.MEM.size=24 >>"%~dp0x"
ECHO.MEM.writeDword(math.floor(X1)) >>"%~dp0x"
ECHO.MEM.writeDword(math.floor(Y1)) >>"%~dp0x"
...
ECHO.EXE(^"SelectObject^",MEMdc2,Brush) >>"%~dp0x"
ECHO.for _,ThisPolygon in pairs(Polygons) do >>"%~dp0x"
ECHO.EXE(^"FillRgn^",MEMdc2,ThisPolygon,Brush) >>"%~dp0x"
ECHO.EXE(^"DeleteObject^",ThisPolygon) >>"%~dp0x"
ECHO.end >>"%~dp0x"
ECHO.EXE(^"DeleteObject^",Brush) >>"%~dp0x"
ECHO.local BlendFunc=(Transparency^<^<16)^|0x00000000 >>"%~dp0x"
ECHO.EXE(^"AlphaBlend^",MEMdc,0,0,W,H,MEMdc2,0,0,W,H,BlendFunc) >>"%~dp0x"
ECHO.EXE(^"BitBlt^",GDIdc,0,0,W,H,MEMdc,0,0,SRCCOPY) >>"%~dp0x"
ECHO.EXE(^"DeleteObject^",BMP2) >>"%~dp0x"
ECHO.EXE(^"DeleteDC^",MEMdc2) >>"%~dp0x"
ECHO.EXE(^"DeleteObject^",BMP) >>"%~dp0x"
ECHO.EXE(^"DeleteDC^",MEMdc) >>"%~dp0x"
ECHO.GlobalOffset=GlobalOffset+Speed >>"%~dp0x"
ECHO.end >>"%~dp0x"
ECHO.function CRTShader(t,ColorOffsetAmount,Transparency) >>"%~dp0x"
ECHO.if ColorOffsetAmount==nil then ColorOffsetAmount=2 end >>"%~dp0x"
ECHO.if Transparency==nil then Transparency=127 end >>"%~dp0x"
ECHO.local W=GetWidth() >>"%~dp0x"
ECHO.local H=GetHeight() >>"%~dp0x"
ECHO.local MEMdc_R=EXE(^"CreateCompatibleDC^",GDIdc) >>"%~dp0x"
ECHO.local BMP_R=EXE(^"CreateCompatibleBitmap^",GDIdc,W,H) >>"%~dp0x"
...
ECHO.local MEMdc_Main=EXE(^"CreateCompatibleDC^",GDIdc) >>"%~dp0x"
ECHO.local BMP_Main=EXE(^"CreateCompatibleBitmap^",GDIdc,W,H) >>"%~dp0x"
ECHO.if Transparency^<255 and ColorOffsetAmount~=0 then >>"%~dp0x"
ECHO.EXE(^"SelectObject^",MEMdc_R,BMP_R) >>"%~dp0x"
ECHO.local Brush=EXE(^"CreateSolidBrush^",0x0000FF) >>"%~dp0x"
ECHO.EXE(^"SelectObject^",MEMdc_R,Brush) >>"%~dp0x"
ECHO.EXE(^"PatBlt^",MEMdc_R,0,0,W,H,PATCOPY) >>"%~dp0x"
...
ECHO.EXE(^"BitBlt^",MEMdc_B,0,0,W,H,PFXdc,0,0,SRCAND) >>"%~dp0x"
ECHO.EXE(^"SelectObject^",MEMdc_Main,BMP_Main) >>"%~dp0x"
ECHO.EXE(^"BitBlt^",MEMdc_Main,ColorOffsetAmount,0,W,H,MEMdc_R,0,0,SRCPAINT) >>"%~dp0x"
ECHO.EXE(^"BitBlt^",MEMdc_Main,-ColorOffsetAmount,0,W,H,MEMdc_G,0,0,SRCPAINT) >>"%~dp0x"
ECHO.EXE(^"BitBlt^",MEMdc_Main,0,ColorOffsetAmount,W,H,MEMdc_B,0,0,SRCPAINT) >>"%~dp0x"
ECHO.EXE(^"BitBlt^",MEMdc_Main,0,-ColorOffsetAmount,W,H,MEMdc_R,0,0,SRCPAINT) >>"%~dp0x"
ECHO.EXE(^"BitBlt^",MEMdc_Main,ColorOffsetAmount,-ColorOffsetAmount,W,H,MEMdc_G,0,0,SRCPAINT) >>"%~dp0x"
ECHO.EXE(^"BitBlt^",MEMdc_Main,-ColorOffsetAmount,ColorOffsetAmount,W,H,MEMdc_B,0,0,SRCPAINT) >>"%~dp0x"
ECHO.if Transparency^>0 then >>"%~dp0x"
ECHO.local BlendFunc=(Transparency^<^<16)^|0x00000000 >>"%~dp0x"
ECHO.EXE(^"AlphaBlend^",MEMdc_Main,0,0,W,H,PFXdc,0,0,W,H,BlendFunc) >>"%~dp0x"
ECHO.end >>"%~dp0x"
ECHO.else >>"%~dp0x"
ECHO.EXE(^"SelectObject^",MEMdc_Main,BMP_Main) >>"%~dp0x"
ECHO.EXE(^"BitBlt^",MEMdc_Main,0,0,W,H,PFXdc,0,0,SRCCOPY) >>"%~dp0x"
ECHO.end >>"%~dp0x"
ECHO.local Brush=EXE(^"CreateSolidBrush^",0x000000) >>"%~dp0x"
ECHO.EXE(^"SelectObject^",MEMdc_Main,Brush) >>"%~dp0x"
ECHO.local i=math.random(0,2) >>"%~dp0x"
ECHO.while i^<=H do >>"%~dp0x"
ECHO.EXE(^"PatBlt^",MEMdc_Main,0,i,W,1,PATCOPY) >>"%~dp0x"
ECHO.i=i+3 >>"%~dp0x"
ECHO.end >>"%~dp0x"
ECHO.EXE(^"DeleteObject^",Brush) >>"%~dp0x"
ECHO.EXE(^"BitBlt^",GDIdc,0,0,W,H,MEMdc_Main,0,0,SRCCOPY) >>"%~dp0x"
...
ECHO.EXE(^"DeleteDC^",MEMdc_Main) >>"%~dp0x"
ECHO.end >>"%~dp0x"
ECHO.function PixelateShader(t,Multiplier) >>"%~dp0x"
ECHO.if Multiplier==nil then Multiplier=4 end >>"%~dp0x"
ECHO.local MEMdc=EXE(^"CreateCompatibleDC^",GDIdc) >>"%~dp0x"
ECHO.local BMP=EXE(^"CreateCompatibleBitmap^",GDIdc,math.floor(GetWidth()/Multiplier),math.floor(GetHeight()/Multiplier)) >>"%~dp0x"
ECHO.EXE(^"SelectObject^",MEMdc,BMP) >>"%~dp0x"
ECHO.EXE(^"StretchBlt^",MEMdc,0,0,math.floor(GetWidth()/Multiplier),math.floor(GetHeight()/Multiplier),PFXdc,0,0,GetWidth(),GetHeight(),SRCCOPY) >>"%~dp0x"
ECHO.EXE(^"StretchBlt^",GDIdc,0,0,GetWidth(),GetHeight(),MEMdc,0,0,math.floor(GetWidth()/Multiplier),math.floor(GetHeight()/Multiplier),SRCCOPY) >>"%~dp0x"
ECHO.EXE(^"DeleteObject^",BMP) >>"%~dp0x"
ECHO.EXE(^"DeleteDC^",MEMdc) >>"%~dp0x"
ECHO.end >>"%~dp0x"
ECHO.function AlphaPixelateShader(t,Multiplier,Alpha) >>"%~dp0x"
ECHO.if Multiplier==nil then Multiplier=4 end >>"%~dp0x"
ECHO.if Alpha==nil then Alpha=63 end >>"%~dp0x"
ECHO.local MEMdc=EXE(^"CreateCompatibleDC^",GDIdc) >>"%~dp0x"
ECHO.local BMP=EXE(^"CreateCompatibleBitmap^",GDIdc,math.floor(GetWidth()/Multiplier),math.floor(GetHeight()/Multiplier)) >>"%~dp0x"
ECHO.local MEMdc2=EXE(^"CreateCompatibleDC^",GDIdc) >>"%~dp0x"
...
ECHO.EXE(^"StretchBlt^",MEMdc,0,0,math.floor(GetWidth()/Multiplier),math.floor(GetHeight()/Multiplier),PFXdc,0,0,GetWidth(),GetHeight(),SRCCOPY) >>"%~dp0x"
ECHO.EXE(^"SelectObject^",MEMdc2,BMP2) >>"%~dp0x"
ECHO.EXE(^"StretchBlt^",MEMdc2,0,0,GetWidth(),GetHeight(),MEMdc,0,0,math.floor(GetWidth()/Multiplier),math.floor(GetHeight()/Multiplier),SRCCOPY) >>"%~dp0x"
ECHO.local BlendFunc=(Alpha^<^<16)^|0x00000000 >>"%~dp0x"
ECHO.EXE(^"AlphaBlend^",MEMdc2,0,0,GetWidth(),GetHeight(),PFXdc,0,0,GetWidth(),GetHeight(),BlendFunc) >>"%~dp0x"
ECHO.EXE(^"BitBlt^",GDIdc,0,0,GetWidth(),GetHeight(),MEMdc2,0,0,SRCCOPY) >>"%~dp0x"
ECHO.EXE(^"DeleteObject^",BMP) >>"%~dp0x"
ECHO.EXE(^"DeleteDC^",MEMdc) >>"%~dp0x"
ECHO.EXE(^"DeleteObject^",BMP2) >>"%~dp0x"
ECHO.EXE(^"DeleteDC^",MEMdc2) >>"%~dp0x"
ECHO.end >>"%~dp0x"
ECHO.function BetterPixelateShader(t,Multiplier) >>"%~dp0x"
ECHO.if Multiplier==nil then Multiplier=4 end >>"%~dp0x"
ECHO.local MEMdc=EXE(^"CreateCompatibleDC^",GDIdc) >>"%~dp0x"
ECHO.local BMP=EXE(^"CreateCompatibleBitmap^",GDIdc,math.floor(GetWidth()/Multiplier),math.floor(GetHeight()/Multiplier)) >>"%~dp0x"
ECHO.EXE(^"SelectObject^",MEMdc,BMP) >>"%~dp0x"
ECHO.EXE(^"AlphaBlend^",MEMdc,0,0,math.floor(GetWidth()/Multiplier),math.floor(GetHeight()/Multiplier),PFXdc,0,0,GetWidth(),GetHeight(),0x00FF0000) >>"%~dp0x"
ECHO.EXE(^"AlphaBlend^",GDIdc,0,0,GetWidth(),GetHeight(),MEMdc,0,0,math.floor(GetWidth()/Multiplier),math.floor(GetHeight()/Multiplier),0x00FF0000) >>"%~dp0x"
ECHO.EXE(^"DeleteObject^",BMP) >>"%~dp0x"
ECHO.EXE(^"DeleteDC^",MEMdc) >>"%~dp0x"
ECHO.end >>"%~dp0x"
ECHO.function BetterAlphaPixelateShader(t,Multiplier,Alpha) >>"%~dp0x"
ECHO.if Multiplier==nil then Multiplier=4 end >>"%~dp0x"
ECHO.if Alpha==nil then Alpha=63 end >>"%~dp0x"
ECHO.local MEMdc=EXE(^"CreateCompatibleDC^",GDIdc) >>"%~dp0x"
ECHO.local BMP=EXE(^"CreateCompatibleBitmap^",GDIdc,math.floor(GetWidth()/Multiplier),math.floor(GetHeight()/Multiplier)) >>"%~dp0x"
...
ECHO.EXE(^"AlphaBlend^",MEMdc,0,0,math.floor(GetWidth()/Multiplier),math.floor(GetHeight()/Multiplier),PFXdc,0,0,GetWidth(),GetHeight(),0x00FF0000) >>"%~dp0x"
ECHO.EXE(^"SelectObject^",MEMdc2,BMP2) >>"%~dp0x"
ECHO.EXE(^"AlphaBlend^",MEMdc2,0,0,GetWidth(),GetHeight(),MEMdc,0,0,math.floor(GetWidth()/Multiplier),math.floor(GetHeight()/Multiplier),0x00FF0000) >>"%~dp0x"
ECHO.local BlendFunc=(Alpha^<^<16)^|0x00000000 >>"%~dp0x"
ECHO.EXE(^"AlphaBlend^",MEMdc2,0,0,GetWidth(),GetHeight(),PFXdc,0,0,GetWidth(),GetHeight(),BlendFunc) >>"%~dp0x"
ECHO.EXE(^"BitBlt^",GDIdc,0,0,GetWidth(),GetHeight(),MEMdc2,0,0,SRCCOPY) >>"%~dp0x"
ECHO.EXE(^"DeleteObject^",BMP) >>"%~dp0x"
...
ECHO.DisplayShaderFPS=true >>"%~dp0x"

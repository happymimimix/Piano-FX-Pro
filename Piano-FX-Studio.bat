...
ECHO.       [97m╔════════════════════════════════════════════════════════════════╗       
ECHO.       [97m║                   [93m┌────────────────────────┐                   [97m║       
ECHO.       [97m║ [91m»»»»»»»»»»»»»»»»» [93m│ [95mPiano-FX Studio v3.05  [93m│ [91m««««««««««««««««« [97m║       
...
ECHO|set/p=[18;12H[107m[30m (D) Run Piano-FX Pro v3.05                               [100m [40m
...
ECHO|set/p=[18;12H[103m[30m (D) Run Piano FX Pro v3.05                               [40m 
...
ECHO.Microseconds=^"Piano-FX-Pro.exe+99A6B0^" >>"%~dp0x"
ECHO.Ticks=^"Piano-FX-Pro.exe+99A754^" >>"%~dp0x"
ECHO.Resolution=^"Piano-FX-Pro.exe+996318^" >>"%~dp0x"
ECHO.Volume=^"Piano-FX-Pro.exe+99A568^" >>"%~dp0x"
ECHO.Mute=^"Piano-FX-Pro.exe+99A556^" >>"%~dp0x"
ECHO.PlaybackSpeed=^"Piano-FX-Pro.exe+99A558^" >>"%~dp0x"
ECHO.NoteSpeed=^"Piano-FX-Pro.exe+99A560^" >>"%~dp0x"
ECHO.OffsetX=^"Piano-FX-Pro.exe+99A580^" >>"%~dp0x"
ECHO.OffsetY=^"Piano-FX-Pro.exe+99A584^" >>"%~dp0x"
ECHO.Zoom=^"Piano-FX-Pro.exe+99A588^" >>"%~dp0x"
ECHO.StartKey=^"Piano-FX-Pro.exe+99A484^" >>"%~dp0x"
ECHO.EndKey=^"Piano-FX-Pro.exe+99A488^" >>"%~dp0x"
ECHO.KeyMode=^"Piano-FX-Pro.exe+99A480^" >>"%~dp0x"
ECHO.Width=^"Piano-FX-Pro.exe+996310^" >>"%~dp0x"
ECHO.Height=^"Piano-FX-Pro.exe+996314^" >>"%~dp0x"
ECHO.Paused=^"Piano-FX-Pro.exe+99A555^" >>"%~dp0x"
ECHO.Keyboard=^"Piano-FX-Pro.exe+99A579^" >>"%~dp0x"
ECHO.VisualizePitchBends=^"Piano-FX-Pro.exe+99A5D8^" >>"%~dp0x"
ECHO.PhigrosMode=^"Piano-FX-Pro.exe+99A5B0^" >>"%~dp0x"
ECHO.ShowMarkers=^"Piano-FX-Pro.exe+99A5A9^" >>"%~dp0x"
ECHO.TickBased=^"Piano-FX-Pro.exe+99A5A8^" >>"%~dp0x"
ECHO.DisableUI=^"Piano-FX-Pro.exe+99A602^" >>"%~dp0x"
ECHO.LimitFPS=^"Piano-FX-Pro.exe+99A529^" >>"%~dp0x"
ECHO.Caption=^"Piano-FX-Pro.exe+996320^" >>"%~dp0x"
ECHO.MS=1e+3 >>"%~dp0x"
ECHO.S=1e+6 >>"%~dp0x"

...
ECHO.WAPI(^"GetWindowRect^",hPFX,MEM.Memory) >>"%~dp0x"
ECHO.MEM.Position=0 >>"%~dp0x"
ECHO.Px=MEM.readDword() >>"%~dp0x"
ECHO.Py=MEM.readDword() >>"%~dp0x"
ECHO.Pw=MEM.readDword()-Px >>"%~dp0x"
ECHO.Ph=MEM.readDword()-Py >>"%~dp0x"
ECHO.MEM.destroy() >>"%~dp0x"
ECHO.MEM=createMemoryStream() >>"%~dp0x"
ECHO.MEM.size=16 >>"%~dp0x"
ECHO.WAPI(^"GetWindowRect^",hGFX,MEM.Memory) >>"%~dp0x"
ECHO.MEM.Position=0 >>"%~dp0x"
ECHO.Gx=MEM.readDword() >>"%~dp0x"
ECHO.Gy=MEM.readDword() >>"%~dp0x"
ECHO.Gw=MEM.readDword()-Gx >>"%~dp0x"
ECHO.Gh=MEM.readDword()-Gy >>"%~dp0x"
ECHO.Margin=Pw-Gw >>"%~dp0x"
ECHO.MEM.destroy() >>"%~dp0x"
...
ECHO.while GetMicroseconds()^<=EndTime and GetTicks()^<TotalTicks do >>"%~dp0x"
ECHO.ShaderFunction((GetMicroseconds()-StartTime)/(EndTime-StartTime)) >>"%~dp0x"
ECHO.end >>"%~dp0x"
...
ECHO.while GetTicks()^<=EndTime and GetTicks()^<TotalTicks do >>"%~dp0x"
ECHO.ShaderFunction((GetTicks()-StartTime)/(EndTime-StartTime)) >>"%~dp0x"
ECHO.end >>"%~dp0x"
ECHO.end).resume() >>"%~dp0x"
ECHO.end >>"%~dp0x"
...
ECHO.end >>"%~dp0x"
ECHO.function WaveShader(t) >>"%~dp0x"
ECHO.i=0 >>"%~dp0x"
ECHO.while i^<=GetHeight() do >>"%~dp0x"
ECHO.EXE(^"BitBlt^",GDIdc,math.random(-10,10),i,GetWidth(),10,PFXdc,0,i,SRCCOPY) >>"%~dp0x"
ECHO.i=i+math.random(5,10) >>"%~dp0x"
ECHO.end >>"%~dp0x"
ECHO.end >>"%~dp0x"
ECHO.function GlitchShader(t) >>"%~dp0x"
ECHO.i=0 >>"%~dp0x"
ECHO.while i^<=GetWidth() do >>"%~dp0x"
ECHO.if math.random(0,1)==0 then >>"%~dp0x"
ECHO.EXE(^"BitBlt^",GDIdc,i,math.random(-10,10),150,GetHeight(),PFXdc,i,0,SRCPAINT) >>"%~dp0x"
ECHO.else >>"%~dp0x"
ECHO.EXE(^"BitBlt^",GDIdc,i,math.random(-10,10),150,GetHeight(),PFXdc,i,0,SRCAND) >>"%~dp0x"
ECHO.end >>"%~dp0x"
ECHO.i=i+math.random(10,150) >>"%~dp0x"
ECHO.end >>"%~dp0x"
ECHO.end >>"%~dp0x"
ECHO.function ColorBurnShader(t) >>"%~dp0x"
ECHO.MEMdc=EXE(^"CreateCompatibleDC^",GDIdc) >>"%~dp0x"
ECHO.BMP=EXE(^"CreateCompatibleBitmap^",GDIdc,GetWidth(),GetHeight()) >>"%~dp0x"
ECHO.EXE(^"SelectObject^",MEMdc,BMP) >>"%~dp0x"
ECHO.EXE(^"BitBlt^",MEMdc,0,0,GetWidth(),GetHeight(),PFXdc,0,0,SRCCOPY) >>"%~dp0x"
ECHO.Brush=EXE(^"CreateSolidBrush^",0x00FF00) >>"%~dp0x"
...
ECHO.end >>"%~dp0x"
ECHO.function ColorOffsetShader(t) >>"%~dp0x"
ECHO.MEMdc=EXE(^"CreateCompatibleDC^",GDIdc) >>"%~dp0x"
ECHO.BMP=EXE(^"CreateCompatibleBitmap^",GDIdc,GetWidth(),GetHeight()) >>"%~dp0x"
ECHO.MEMdc2=EXE(^"CreateCompatibleDC^",GDIdc) >>"%~dp0x"
ECHO.BMP2=EXE(^"CreateCompatibleBitmap^",GDIdc,GetWidth(),GetHeight()) >>"%~dp0x"
ECHO.EXE(^"SelectObject^",MEMdc2,BMP2) >>"%~dp0x"
ECHO.EXE(^"BitBlt^",MEMdc2,0,0,GetWidth(),GetHeight(),PFXdc,0,0,SRCCOPY) >>"%~dp0x"
ECHO.Brush=EXE(^"CreateSolidBrush^",0x00FFFF) >>"%~dp0x"
ECHO.EXE(^"SelectObject^",MEMdc2,Brush) >>"%~dp0x"
ECHO.EXE(^"PatBlt^",MEMdc2,0,0,GetWidth(),GetHeight(),PATINVERT) >>"%~dp0x"
ECHO.EXE(^"DeleteObject^",Brush) >>"%~dp0x"
ECHO.EXE(^"SelectObject^",MEMdc,BMP) >>"%~dp0x"
ECHO.EXE(^"BitBlt^",MEMdc,math.random(-20,20),math.random(-20,20),GetWidth(),GetHeight(),MEMdc2,0,0,SRCPAINT) >>"%~dp0x"
...
ECHO.EXE(^"SelectObject^",MEMdc2,BMP2) >>"%~dp0x"
ECHO.EXE(^"BitBlt^",MEMdc2,0,0,GetWidth(),GetHeight(),PFXdc,0,0,SRCCOPY) >>"%~dp0x"
ECHO.Brush=EXE(^"CreateSolidBrush^",0xFF00FF) >>"%~dp0x"
ECHO.EXE(^"SelectObject^",MEMdc2,Brush) >>"%~dp0x"
ECHO.EXE(^"PatBlt^",MEMdc2,0,0,GetWidth(),GetHeight(),PATINVERT) >>"%~dp0x"
ECHO.EXE(^"DeleteObject^",Brush) >>"%~dp0x"
ECHO.EXE(^"SelectObject^",MEMdc,BMP) >>"%~dp0x"
...
ECHO.EXE(^"SelectObject^",MEMdc2,BMP2) >>"%~dp0x"
ECHO.EXE(^"BitBlt^",MEMdc2,0,0,GetWidth(),GetHeight(),PFXdc,0,0,SRCCOPY) >>"%~dp0x"
ECHO.Brush=EXE(^"CreateSolidBrush^",0xFFFF00) >>"%~dp0x"
ECHO.EXE(^"SelectObject^",MEMdc2,Brush) >>"%~dp0x"
ECHO.EXE(^"PatBlt^",MEMdc2,0,0,GetWidth(),GetHeight(),PATINVERT) >>"%~dp0x"
ECHO.EXE(^"DeleteObject^",Brush) >>"%~dp0x"
ECHO.EXE(^"SelectObject^",MEMdc,BMP) >>"%~dp0x"
...
ECHO.EXE(^"DeleteDC^",MEMdc) >>"%~dp0x"
ECHO.end >>"%~dp0x"
ECHO.function ColorOffsetWaveShader(t) >>"%~dp0x"
ECHO.MEMdc=EXE(^"CreateCompatibleDC^",GDIdc) >>"%~dp0x"
ECHO.BMP=EXE(^"CreateCompatibleBitmap^",GDIdc,GetWidth(),GetHeight()) >>"%~dp0x"
ECHO.MEMdc2=EXE(^"CreateCompatibleDC^",GDIdc) >>"%~dp0x"
ECHO.BMP2=EXE(^"CreateCompatibleBitmap^",GDIdc,GetWidth(),GetHeight()) >>"%~dp0x"
...
ECHO.i=0 >>"%~dp0x"
ECHO.while i^<=GetHeight() do >>"%~dp0x"
ECHO.EXE(^"BitBlt^",MEMdc,math.random(-10,10),i,GetWidth(),40,PFXdc,0,i,SRCAND) >>"%~dp0x"
ECHO.EXE(^"BitBlt^",GDIdc,0,i,GetWidth(),40,MEMdc,0,i,SRCCOPY) >>"%~dp0x"
ECHO.i=i+math.random(10,40) >>"%~dp0x"
ECHO.end >>"%~dp0x"
ECHO.EXE(^"DeleteObject^",BMP) >>"%~dp0x"
ECHO.EXE(^"DeleteDC^",MEMdc) >>"%~dp0x"
ECHO.end >>"%~dp0x"
ECHO.function MEMZTunnelShader(t) >>"%~dp0x"
ECHO.if math.random(0,40)==0 or layer==nil or delay==nil then >>"%~dp0x"
ECHO.if math.random(0,4)==0 then >>"%~dp0x"
...
ECHO.if delay^>=10 then >>"%~dp0x"
ECHO.layer=layer*0.9 >>"%~dp0x"
ECHO.delay=0 >>"%~dp0x"
ECHO.end >>"%~dp0x"
ECHO.if math.random(0,4)==0 then >>"%~dp0x"
...
ECHO.RunShaderByTime(-3*S,-S,WaveShader) >>"%~dp0x"
ECHO.RunShaderByTime(-S,0,GlitchShader) >>"%~dp0x"

...
ECHO.Color=(B^<^<16)^|(G^<^<8)^|R >>"%~dp0x"
ECHO.Brush=EXE(^"CreateSolidBrush^",Color) >>"%~dp0x"
...
ECHO.Alpha=math.ceil((MaxAlpha-MinAlpha)*(1.0-t)+MinAlpha) >>"%~dp0x"
ECHO.BlendFunc=(Alpha^<^<16)^|0x00000000 >>"%~dp0x"
...
ECHO.EXE(^"SelectObject^",MEMdc,BMP) >>"%~dp0x"
ECHO.EXE(^"PatBlt^",MEMdc,0,0,GetWidth(),GetHeight(),BLACKNESS) >>"%~dp0x"
ECHO.Alpha=math.ceil((MaxAlpha-MinAlpha)*t+MinAlpha) >>"%~dp0x"
ECHO.BlendFunc=(Alpha^<^<16)^|0x00000000 >>"%~dp0x"
ECHO.EXE(^"AlphaBlend^",MEMdc,0,0,GetWidth(),GetHeight(),PFXdc,0,0,GetWidth(),GetHeight(),BlendFunc) >>"%~dp0x"
ECHO.EXE(^"BitBlt^",GDIdc,0,0,GetWidth(),GetHeight(),MEMdc,0,0,SRCCOPY) >>"%~dp0x"
ECHO.EXE(^"DeleteObject^",BMP) >>"%~dp0x"
...
ECHO.EXE(^"BitBlt^",MEMdc,0,0,GetWidth(),GetHeight(),PFXdc,0,0,SRCCOPY) >>"%~dp0x"
ECHO.Color=(B^<^<16)^|(G^<^<8)^|R >>"%~dp0x"
ECHO.Brush=EXE(^"CreateHatchBrush^",math.random(0,5),Color) >>"%~dp0x"
ECHO.EXE(^"SelectObject^",MEMdc,Brush) >>"%~dp0x"
ECHO.BkColor=(BkB^<^<16)^|(BkG^<^<8)^|BkR >>"%~dp0x"
...
ECHO.EXE(^"SelectObject^",MEMdc,BMP) >>"%~dp0x"
ECHO.EXE(^"BitBlt^",MEMdc,0,0,GetWidth(),GetHeight(),PFXdc,0,0,SRCCOPY) >>"%~dp0x"
ECHO.Color=(TextB^<^<16)^|(TextG^<^<8)^|TextR >>"%~dp0x"
...
ECHO.BkColor=(BkB^<^<16)^|(BkG^<^<8)^|BkR >>"%~dp0x"
ECHO.EXE(^"SetBKColor^",MEMdc,BkColor) >>"%~dp0x"
ECHO.Font=EXE(^"CreateFontA^", >>"%~dp0x"
...
ECHO.EXE(^"GetTextExtentPoint32A^",MEMdc,Text,#Text,MEM.Memory) >>"%~dp0x"
ECHO.MEM.Position=0 >>"%~dp0x"
ECHO.W=MEM.readDword() >>"%~dp0x"
ECHO.H=MEM.readDword() >>"%~dp0x"
ECHO.MEM.destroy() >>"%~dp0x"
...
ECHO.Y=math.floor(PosY-H) >>"%~dp0x"
ECHO.end >>"%~dp0x"
ECHO.EXE(^"TextOutA^",MEMdc,X,Y,Text,#Text) >>"%~dp0x"
ECHO.EXE(^"BitBlt^",GDIdc,0,0,GetWidth(),GetHeight(),MEMdc,0,0,SRCCOPY) >>"%~dp0x"
...
ECHO.MEM=createMemoryStream() >>"%~dp0x"
ECHO.MEM.size=8 >>"%~dp0x"
ECHO.EXE(^"GetTextExtentPoint32A^",MEMdc,Text,math.ceil(#Text*t),MEM.Memory) >>"%~dp0x"
ECHO.MEM.Position=0 >>"%~dp0x"
ECHO.W=MEM.readDword() >>"%~dp0x"
ECHO.H=MEM.readDword() >>"%~dp0x"
ECHO.MEM.destroy() >>"%~dp0x"
...
ECHO.Y=math.floor(PosY-H) >>"%~dp0x"
ECHO.end >>"%~dp0x"
ECHO.EXE(^"TextOutA^",MEMdc,X,Y,Text,math.ceil(#Text*t)) >>"%~dp0x"
ECHO.EXE(^"BitBlt^",GDIdc,0,0,GetWidth(),GetHeight(),MEMdc,0,0,SRCCOPY) >>"%~dp0x"
ECHO.EXE(^"DeleteObject^",Font) >>"%~dp0x"
ECHO.EXE(^"DeleteObject^",BMP) >>"%~dp0x"
ECHO.EXE(^"DeleteDC^",MEMdc) >>"%~dp0x"
...
ECHO.MEM=createMemoryStream() >>"%~dp0x"
ECHO.MEM.size=8 >>"%~dp0x"
ECHO.EXE(^"GetTextExtentPoint32A^",MEMdc,Text,math.ceil(#Text*(1.0-t)),MEM.Memory) >>"%~dp0x"
ECHO.MEM.Position=0 >>"%~dp0x"
ECHO.W=MEM.readDword() >>"%~dp0x"
ECHO.H=MEM.readDword() >>"%~dp0x"
ECHO.MEM.destroy() >>"%~dp0x"
...
ECHO.Y=math.floor(PosY-H) >>"%~dp0x"
ECHO.end >>"%~dp0x"
ECHO.EXE(^"TextOutA^",MEMdc,X,Y,Text,math.ceil(#Text*(1.0-t))) >>"%~dp0x"
ECHO.EXE(^"BitBlt^",GDIdc,0,0,GetWidth(),GetHeight(),MEMdc,0,0,SRCCOPY) >>"%~dp0x"
ECHO.EXE(^"DeleteObject^",Font) >>"%~dp0x"
ECHO.EXE(^"DeleteObject^",BMP) >>"%~dp0x"
ECHO.EXE(^"DeleteDC^",MEMdc) >>"%~dp0x"
...
ECHO.RunShaderByTime(-3*S,0,LightenFromDarkShader) >>"%~dp0x"
